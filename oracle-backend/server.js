...
//          COUNT(*) AS TOTAL_COMPLAINTS,
//          SUM(CASE WHEN STATUS = 'Pending' THEN 1 ELSE 0 END) AS PENDING_COMPLAINTS,
//          SUM(CASE WHEN STATUS = 'Under Review' THEN 1 ELSE 0 END) AS UNDER_REVIEW_COMPLAINTS,
...
//         underReview: Number(row.UNDER_REVIEW_COMPLAINTS || 0),
//         assigned: Number(row.ASSIGNED_COMPLAINTS || 0),
...
//         { complaint_id: complaintId, officer_id: Number(officer_id) }
//       );
