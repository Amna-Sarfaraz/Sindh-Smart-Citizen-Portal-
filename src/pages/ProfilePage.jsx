  ...
  return (
    <DashboardLayout>
      ...
      <div className="bg-[#f9f7f1] min-h-screen p-5 font-sans text-gray-800 relative">
        ...
        {/* Background Diagram */}
        <div
          className="absolute bottom-0 left-0 w-[1200px] h-[280px] rounded-2xl overflow-hidden opacity-100"
          style={{
        ...
        <div className="relative z-10">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                <img
                  src={avatar}
                  alt="Avatar"
                  className="w-36 h-36 md:w-40 md:h-40 rounded-full border-2 border-gray-200 object-cover shadow-md"
                />

                {edit && (
                  <label className="absolute bottom-0 right-0 bg-gray-100 px-3 py-1 text-sm rounded-full cursor-pointer hover:bg-gray-200">
                    <input
                      type="file"
                      className="hidden"
                      onChange={(e) => {
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-[#1b3a57]">
                  {data.name}
                </h1>
            ...
            {!edit && (
              <button
                className="bg-[#1b3a57] text-white px-6 py-2 rounded-lg hover:bg-[#254a78] font-semibold shadow-md"
          ...
          <div className="grid lg:grid-cols-2 gap-6 mt-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <h3 className="font-semibold mb-4 text-xl border-b pb-2 text-[#1b3a57]">
                  Complaint Stats
                </h3>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  {metrics.map((m) => (
                    <div
                      key={m.label}
                      className="bg-[#f6f5f1] rounded-xl p-4 shadow-inner"
                    >
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <h3 className="font-semibold mb-3 text-xl border-b pb-2 text-[#1b3a57]">
                  Security Logs
                </h3>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <h3 className="font-semibold mb-4 text-xl text-[#1b3a57]">
                  Profile Details
                </h3>
