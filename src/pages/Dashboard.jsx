...
// const STATS = [
//   { label: "Total Complaints",   value: 57, color: "#e05c1a", bg: "#f97316", icon: "☰" },
//   { label: "Pending Complaints", value: 17, color: "#d97706", bg: "#f59e0b", icon: "⏳" },
//   { label: "In Progress",        value: 8,  color: "#1d4ed8", bg: "#3b82f6", icon: "🔧" },
//   { label: "Resolved Complaints",value: 32, color: "#14863e", bg: "#14863e", icon: "✅" },
// ];

// const CHART_DATA = [
//   { name: "Pending",     value: 17, color: "#f59e0b" },
//   { name: "In Progress", value: 8,  color: "#1568ec" },
//   { name: "Resolved",    value: 32, color: "#14863e" },
// ];

// const RECENT_COMPLAINTS = [
//   { id: 102, title: "Broken Street Light",  dept: "Municipal",        status: "Pending",     date: "11-May-2024" },
//   { id: 98,  title: "Water Supply Issue",   dept: "Water Board",      status: "In Progress", date: "09-May-2024" },
//   { id: 95,  title: "Road Potholes",        dept: "Road Maintenance", status: "Resolved",    date: "06-May-2024" },
//   { id: 89,  title: "Garbage Not Collected",dept: "Municipal",        status: "Pending",     date: "04-May-2024" },
//   { id: 85,  title: "Power Outage",         dept: "Electricity Dept", status: "Resolved",    date: "02-May-2024" },
// ];
...
//   const [complaints] = useState(RECENT_COMPLAINTS);
