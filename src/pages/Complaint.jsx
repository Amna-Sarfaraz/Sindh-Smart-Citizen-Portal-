...
// // Timeline steps derived from complaint status
...
// function Complaint() {
//   // ── Auth: get logged-in user from localStorage ──────────────────
...
//   const [selected,    setSelected]      = useState(null);   // for timeline
...
//       .then(data => {
//         setDepartments(data);
//         if (data.length) setDeptId(data[0].DEPT_ID);
//       })
//       .catch(console.error);
//   }, []);
...
//       .then(data => {
//         setComplaints(data);
//         // Auto-select most recent for timeline
...
//   // ── Timeline source: selected row or first complaint ─────────────
...
//                     {fileData && (
//                       <button
//                         onClick={() => { setFileData(null); if (fileRef.current) fileRef.current.value = ''; }}
...
//                       <th key={h} className="border-b border-[#e0e6ef] bg-[#f0f4fa] px-2.5 py-2 text-left text-[0.8rem] font-bold text-[#2e4870]">
//                         {h}
//                       </th>
//                     ))}
//                   </tr>
...
//                   {complaints.length === 0 ? (
//                     <tr>
//                       <td colSpan={6} className="py-6 text-center text-[0.82rem] text-[#8a9abb]">
//                         No complaints found.
//                       </td>
//                     </tr>
//                   ) : complaints.map(item => (
